package com.lcb.pickerview.lib;
...
import com.lcb.R;
import com.lcb.pickerview.adapter.WheelAdapter;
import com.lcb.pickerview.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            mGravity = a.getInt(R.styleable.wheelview_gravityPickView, Gravity.CENTER);
    ...
    /**
     * 设置是否循环滚动 如何数据有123你会无限循环123123123...........(不会自动滚动）
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(label != null) {
            /*设置单位颜色*/
            paintCenterText.setColor(getResources().getColor(R.color.red));
