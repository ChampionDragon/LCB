...
import com.lcb.Ezviz.DeviceModel;
...
public class SeriesNumSearchActivity extends RootActivity implements View.OnClickListener/*, OnAuthListener*/ {
    ...
    private void init() {
        ...
        Logs.e("seriesNum191    mSerialNoStr = " + mSerialNoStr + ",mVerifyCode = " + mVerifyCode + ",deviceType="
                + mDeviceModel);
...
//                mTriggerHelper.onNewIntent(intent);
    ...
    private void handleAddCameraSuccess() {
        ...
        Logs.i(mString+"  504"+mSerialNoStr);
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    Logs.i(mString+"  872"+mSerialNoStr+"   "+mVerifyCode);

                    /***********如有需要开发者需要自己保存此验证码***********/
//                    if (!TextUtils.isEmpty(mVerifyCode)) {
//                        //保存密码
//                        BaseApplication.getOpenSDK().setValidateCode(mVerifyCode, mSerialNoStr);
//                    }
