...
import com.lcb.Ezviz.AlarmType;
...
//        });
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            // 消息底部栏变化
            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mMessageTypeView.getLayoutParams();

            layoutParams = (RelativeLayout.LayoutParams) mMessageTimeView.getLayoutParams();
            ...
            layoutParams = (RelativeLayout.LayoutParams) mMessageFromView.getLayoutParams();
            layoutParams.topMargin = 0;
            layoutParams.leftMargin = Utils.dip2px(this, 15);
            layoutParams.width = RelativeLayout.LayoutParams.WRAP_CONTENT;
            layoutParams.addRule(RelativeLayout.BELOW, 0);
            ...
            mMessageFromView.setEllipsize(TextUtils.TruncateAt.END);
...
//            mVideoButton.setTextColor(getResources().getColorStateList(R.color.message_full_video_button_selector));
            layoutParams = (RelativeLayout.LayoutParams) mVideoButton.getLayoutParams();
            layoutParams.width = RelativeLayout.LayoutParams.WRAP_CONTENT;
