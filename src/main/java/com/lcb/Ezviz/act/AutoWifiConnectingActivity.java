...
public class AutoWifiConnectingActivity extends RootActivity implements View.OnClickListener/*, OnAuthListener*/ {
...
//                            LocalInfo.getInstance().setWifiPassword(mac, wifiPassword);
        ...
        BaseApplication.getOpenSDK().startConfigWifi(AutoWifiConnectingActivity.this, serialNo, wifiSSID, wifiPassword, mEZStartConfigWifiCallback);
    }
        ...
        new Thread() {
            public void run() {
                ...
                while (count > 0) {
                    ...
                    try {
                        BaseApplication.getOpenSDK().addDevice(serialNo, mVerifyCode);
...
//                        if (!TextUtils.isEmpty(mVerifyCode)) {
//                            //保存密码
//                            BaseApplication.getOpenSDK().setValidateCode(mVerifyCode, serialNo);
//                        }
