...
import com.lcb.Ezviz.EZMessageListAdapter2;
import com.lcb.Ezviz.PinnedSectionListView;
...
import com.lcb.Ezviz.PullToRefreshPinnedSectionListView;
...
//            try {
            ...
            try {
                result = BaseApplication.getOpenSDK().getAlarmList(mDeviceSerial, pageStart, pageSize,mStartTime,
                        mEndTime);
            }
...
//                mAdapter.();
    ...
    private class DeleteAlarmMessageTask extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            ...
            try {
                BaseApplication.getOpenSDK().deleteAlarm(deleteIds);
            }
            catch (BaseException e) {
                e.printStackTrace();
...
//            }
    ...
    private class CheckAlarmInfoTask extends AsyncTask<EZAlarmInfo, Void, Boolean> {
        ...
        protected Boolean doInBackground(EZAlarmInfo... params) {
            ...
            try {
                BaseApplication.getOpenSDK().setAlarmStatus(alarmIds, EZConstants.EZAlarmStatus.EZAlarmStatusRead);
                setAlarmRead(info);
                return true;
            }
            catch (BaseException e) {
