...
public class EZMessageListAdapter2 extends BaseAdapter implements View.OnClickListener, View.OnCreateContextMenuListener,
        CompoundButton.OnCheckedChangeListener, PinnedSectionListView.PinnedSectionListAdapter {
...
//                id = ((LeaveMessageItem) item).getMessageId();
    ...
    public List<String> getCheckedIds() {
        ...
        Set<Map.Entry<String, Boolean>> entries = mCheckStates.entrySet();
